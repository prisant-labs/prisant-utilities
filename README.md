...
|---|---|---|
| [`plab-wrap-session`](docs/skills/plab-wrap-session/README.md) | Close a coding session with a structured log: hygiene sweep, evidence index, and a copy-paste-ready continuation prompt for next time | 1.6.1 |
| [`plab-continue-session`](docs/skills/plab-continue-session/README.md) | Resume from the most recent session log and pick up the named next action | 1.4.0 |
...
| [`plab-release-plan`](docs/skills/plab-release-plan/README.md) | Scope a release, promote efforts into it, and gate the tag on hygiene checks and a doc-update checklist | 1.4.0 |
