...
- `skills/plab-wrap-session/HISTORY.md`: new `1.6.0` entry (or addition to one opened by a co-landing v0.4.0 effort) recording this change.
...
- Root `README.md`: version-table entry for `plab-wrap-session` updated to 1.6.0 (shared step with any other v0.4.0 effort landing in the same version; see Phase 3).
