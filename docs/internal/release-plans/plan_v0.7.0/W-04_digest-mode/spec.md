...
| D3 | Should `skills/plab-wrap-session/scripts/aggregate-logs.py` call a per-log parsing utility from W-02 (derived log facts, shipping v0.6.0, before this effort) instead of parsing Markdown sections itself? | Resolved: no, see below |
