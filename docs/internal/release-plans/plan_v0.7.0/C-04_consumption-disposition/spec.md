...
(resumed-from semantics, the roadmap's D-6, shipping in v0.3.0), which fixes `resumed-from` itself to
...
3. The field is written only when this session's `resumed-from:` value was itself set via an actual
   ...
   v0.3.0) fix to `resumed-from` itself: never inferred from narrative memory, and omitted when no
...
[S5] `docs/internal/release-plans/plan_v0.7.0/plan_v0.7.0.md`. Class A. Context section (C-04
paragraph), lines 35-46; Open Question D1 (W-06 deferred, resolved), lines 107 and 110-144.

[S6] `docs/internal/release-plans/plan_v0.3.0/plan_v0.3.0.md`. Class A. Confirms D-06 ships in v0.3.0
