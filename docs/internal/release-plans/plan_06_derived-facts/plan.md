...
title: "Release plan 06: Derived facts"
type: release-plan
status: in-progress
created: 2026-08-23
updated: 2026-08-23
...
| Doc | Update | Done |
|-----|--------|------|
| `CHANGELOG.md` | Move items from [Unreleased] to v0.7.0 section | [ ] |
...
| Git tag `v0.7.0` | Create the annotated tag once all of the above are done | [ ] |
...
It is also the substrate for v0.8.0's aggregation work, because a digest over logs whose facts were
