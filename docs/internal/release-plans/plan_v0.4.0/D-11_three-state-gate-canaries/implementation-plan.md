...
tracked in `docs/internal/release-plans/plan_v0.4.0/plan_v0.4.0.md`'s Doc-Update Checklist, shared across
...
- **Sequencing precondition:** D-12 (path citation precision)
  (`docs/internal/release-plans/plan_v0.4.0/D-12_path-citation-precision/`) must already be merged to
...
using the same canary-before-trust pattern (`docs/internal/release-plans/plan_v0.4.0/plan_v0.4.0.md`,
