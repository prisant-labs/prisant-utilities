...
- **[S2]** `_local/migration/2026-08-14/pii-gate.py`. Maintainer-local, gitignored (not shipped in this
  ...
  AC.
- **[S3]** `docs/internal/release-plans/plan_v0.4.0/plan_v0.4.0.md`, decision D2 (lines 153-186).
...
- **[S5]** `docs/internal/release-plans/plan_v0.4.0/CI-01_ci-bootstrap/spec.md`, Purpose section and
...
`docs/internal/release-plans/plan_v0.4.0/plan_v0.4.0.md` decision D2 [S3], reads: "the checker must be a
