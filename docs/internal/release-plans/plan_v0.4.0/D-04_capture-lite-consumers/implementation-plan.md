...
a release-level action gated by all eight v0.4.0 efforts completing (`plan_v0.4.0.md` Hygiene Gate
...
- If another v0.4.0 effort (most likely D-05) has already added a numbered item to wrap's Evidence
...
or move any `.github/workflows/` file. CI-01 (a separate v0.4.0 effort) gives this repository
...
- `library.json`: component versions only (Phase 3). The top-level plugin version and both
  ...
  action gated by all eight v0.4.0 efforts completing (`plan_v0.4.0.md` Hygiene Gate (f)), performed
