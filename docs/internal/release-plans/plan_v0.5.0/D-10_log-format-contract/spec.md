...
- [S11] `docs/internal/release-plans/plan_v0.5.0/W-02_derived-log-facts/spec.md`. This session's own prior artifact, written before this document and verified by direct reading.
