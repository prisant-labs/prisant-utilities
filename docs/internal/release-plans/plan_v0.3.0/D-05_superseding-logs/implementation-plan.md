...
a release-level action gated by all eight v0.3.0 efforts completing (see `plan_v0.3.0.md`'s Hygiene
...
- If another v0.3.0 effort (most likely D-04 or D-07) has already added a numbered item to wrap's
...
- [ ] Step 4: Add (or append to, if present) the `## 1.6.0` row and section in
  `skills/plab-wrap-session/HISTORY.md`. If the row and heading already exist (a sibling v0.3.0 effort
  ...
  `| 1.6.0 | 2026-08-23 | v0.3.0 | added | Gates that cannot fail open: see the 1.6.0 section for the full list. |`
...
- [ ] Step 3: Bump continue's frontmatter, only if no sibling v0.3.0 effort (most likely D-04) has
...
or move any `.github/workflows/` file. CI-01 (CI bootstrap, a separate v0.3.0 effort) gives this
