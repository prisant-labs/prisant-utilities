...
- No bump to `library.json`, `.claude-plugin/plugin.json`, or `.codex-plugin/plugin.json` version numbers. Those move once, at release time, across every effort landing in v0.3.0, not per effort.
