...
[S5] `docs/internal/release-plans/plan_v0.8.0/plan_v0.8.0.md`. Class A. Context section (C-04
paragraph), lines 35-46; Open Question D1 (W-06 deferred, resolved), lines 107 and 110-144.

[S6] `docs/internal/release-plans/plan_v0.4.0/plan_v0.4.0.md`. Class A. Confirms D-06 ships in v0.4.0
