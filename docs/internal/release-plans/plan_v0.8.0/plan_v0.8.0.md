...
| Doc | Update | Done |
|-----|--------|------|
| `CHANGELOG.md` | Move items from [Unreleased] to v0.8.0 section | [ ] |
...
| Git tag `v0.8.0` | Create the annotated tag once all of the above are done | [ ] |
