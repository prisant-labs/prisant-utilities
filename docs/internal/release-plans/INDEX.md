...
|---|---|---|---|---|---|---|
| [A-02](_unassigned/A-02_programmatic-review-dispatch/spec.md) | programmatic review dispatch | A (ai-review roadmap item) | committed | draft | P1 | No |
...
| [A-02](_unassigned/A-02_programmatic-review-dispatch/spec.md) | programmatic review dispatch | A (ai-review roadmap item) | committed | draft | `_unassigned/` | - | P1 | No |
