...
title: "Release plan 07: Aggregation"
type: release-plan
status: in-progress
created: 2026-08-23
updated: 2026-08-23
...
(derived log facts, v0.7.0) means the facts being aggregated were derived rather than recalled.
...
* **Option A:** `skills/plab-wrap-session/scripts/aggregate-logs.py`, with continue invoking it across
  the skill boundary. Keeps the aggregation adjacent to the log-format contract that v0.7.0 puts in
